				...
				<div class="footer-widgets-wrap clearfix">
					...
					<div class="col_two_fifth">
						...
						<div class="widget clearfix">
							...
							<p class="ls1 t300" style="opacity: 0.6; font-size: 13px;">Copyrights &copy; 2018 Sedulur.ga</p>
					...
					<div class="col_three_fifth col_last">
						...
						<div class="col_half">
							<h4 class="ls1 t400 uppercase">Kelurahan Terbaik</h4>
						...
						<div class="col_half col_last">
							...
							<div class="widget subscribe-widget subscribe-form clearfix" data-loader="button">
								...
								<form action="include/subscribe.php" role="form" method="post" class="nobottommargin">
									<input type="email" id="widget-subscribe-form-email" name="widget-subscribe-form-email" class="sm-form-control not-dark required email" placeholder="Masukkan Email Anda">
									<button class="button button-3d button-black noleftmargin norightmargin" style="margin-top: 15px;" type="submit">Berlangganan</button>
								</form>
							</div>
