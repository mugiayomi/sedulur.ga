	...
	<div class="row">
		...
		<div class="col-xl-5 col-lg-6">
			...
			<div class="card card-transparent">
				...
				<div class="card-block">
					<h3>Showcase and guide users with a
						<br> better User Interface &amp; Experience.</h3>
	...
	<div class="row">
		<div class="col-md-5">
			...
			<div class="card card-transparent">
				...
				<div class="card-block">
					<h3>Attach your Forms to Organize &amp; Create Contemporary feels</h3>
					<p>Despite the UI, We thought of the User experience, With attached From Layouts you can simply categories Important fields
						and prioritize them.</p>
					<br>
					<div>
						<div class="profile-img-wrapper m-t-5 inline">
							<img width="35" height="35" src="assets/img/profiles/avatar_small.jpg" alt="" data-src="assets/img/profiles/avatar_small.jpg"
				...
				<div class="card-block">
					<form id="form-project" role="form" autocomplete="off" novalidate>
						...
						<div class="form-group-attached">
							<div class="form-group form-group-default">
								<label>Investor
									<i class="fa fa-info text-complete m-l-5"></i>
								</label>
						...
						<button class="btn btn-default">
							<i class="pg-close"></i> Clear</button>
					</form>
				</div>
			</div>
			<!-- END card -->
		...
		<div class="card-block">
			<div class="row">
				<div class="col-md-10">
					...
					<p>Want it to be more Descriptive and User Friendly, We Made it possible, Use Seperated Form Layouts Structure to Presentate
						your Form Fields.
					</p>
					<br>
