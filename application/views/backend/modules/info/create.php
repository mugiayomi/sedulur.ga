		...
		<div class="col-xl-12 col-lg-12">
			...
			<div class="card card-transparent">
				<div class="card-block">
					<form method="POST" action="<?=base_url('admin/info/store')?>" role="form" autocomplete="off"  enctype="multipart/form-data">
							...
							<div class="col-md-12">
								<div class="form-group form-group-default input-group">
									<div class="form-input-group">
										<label>Judul</label>
										<input type="text" class="form-control" name="judul" placeholder="Nama Info" required>
									</div>
								</div>
							</div>
						</div>
