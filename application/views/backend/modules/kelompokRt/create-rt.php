		...
		<div class="col-xl-12 col-lg-12">
			...
			<div class="card card-transparent">
				<div class="card-block">
					<form method="POST" action="<?=base_url('admin/kelompok-rt/storeRt')?>" role="form" autocomplete="off">
							...
							<div class="col-md-12">
								<div class="form-group form-group-default input-group">
									<div class="form-input-group">
										<label>Nama RT</label>
										<input type="text" class="form-control" name="nama_rt" placeholder="Contoh: RT 015, RT 001" required>
									</div>
								</div>
							</div>
						</div>
