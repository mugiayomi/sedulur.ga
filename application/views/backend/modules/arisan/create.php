		...
		<div class="col-xl-12 col-lg-12">
			...
			<div class="card card-transparent">
				<div class="card-block">
					<form method="POST" action="<?=base_url('admin/arisan/store')?>" role="form" autocomplete="off">
							...
							<div class="col-md-12">
								<div class="form-group form-group-default input-group">
									<div class="form-input-group">
										<label>Arisan</label>
										<input type="text" class="form-control" name="arisan" placeholder="Nama Arisan" required>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="col-md-12">
								<div class="form-group form-group-default input-group">
									<div class="form-input-group">
										...
										<input type="text" class="form-control" name="jumlah_peserta" placeholder="Jumlah Peserta Arisan" required>
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">
								<div class="form-group form-group-default input-group">
									<div class="form-input-group">
										<label>Iuran </label>
										<input type="text" class="form-control" name="iuran" placeholder="Jumlah Iuran Per Periode" required>
									</div>
								</div>
							</div>
						</div>
