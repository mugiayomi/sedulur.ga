<!-- BEGIN VENDOR JS -->
<script src="<?=base_url()?>assets/backend/assets/plugins/feather-icons/feather.min.js" type="text/javascript"></script>
...
<script src="<?=base_url()?>assets/backend/assets/plugins/tether/js/tether.min.js" type="text/javascript"></script>
<script src="<?=base_url()?>assets/backend/assets/plugins/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
...
<script type="text/javascript" src="<?=base_url()?>assets/backend/assets/plugins/select2/js/select2.full.min.js"></script>
...
<!-- BEGIN PAGE LEVEL JS -->
<script src="<?=base_url()?>assets/backend/assets/js/form_layouts.js" type="text/javascript"></script>
